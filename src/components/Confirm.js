...
export class FormUserDeatils extends Component {
  ...
  render() {
    const { values : {firstName , lastName , emailId , contactNumber , occupation , 
        city , bio} } = this.props;
      ...
      <MuiThemeProvider>
        <React.Fragment>
            ...
            <List>
                ...
                <ListItem primaryText="Email" secondaryText={emailId}/>
            ...
            <br/>
            <RaisedButton label="Confirm & Continue" primary={true} style={styles.button} 
